                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="street_address" id="street_address" value="{{ old('street_address', $user->street_address) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="zip_code" id="zip_code" value="{{ old('zip_code', $user->zip_code) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="agree_to_terms" id="agree_to_terms" value="1" {{ $user->agree_to_terms || old('agree_to_terms', 0) === 1 ? 'checked' : '' }}>
