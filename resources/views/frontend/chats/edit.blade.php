                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.chats.update", [$chat->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="message" id="message">{!! old('message', $chat->message) !!}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="read" id="read" value="1" {{ $chat->read || old('read', 0) === 1 ? 'checked' : '' }}>
