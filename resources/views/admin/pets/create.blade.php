        ...
        <form method="POST" action="{{ route("admin.pets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('not_available') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="not_available" id="not_available" value="1" {{ old('not_available', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('from_time') ? 'is-invalid' : '' }}" type="text" name="from_time" id="from_time" value="{{ old('from_time') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('to_time') ? 'is-invalid' : '' }}" type="text" name="to_time" id="to_time" value="{{ old('to_time') }}">
