...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('agree_to_terms') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="agree_to_terms" value="0">
                    <input class="form-check-input" type="checkbox" name="agree_to_terms" id="agree_to_terms" value="1" {{ old('agree_to_terms', 0) == 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="agree_to_terms">{{ trans('cruds.user.fields.agree_to_terms') }}</label>
                </div>
