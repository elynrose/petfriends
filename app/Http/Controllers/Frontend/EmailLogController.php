...
class EmailLogController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.emailLogs.index', compact('emailLogs'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.emailLogs.create');
    }
    ...
    public function store(StoreEmailLogRequest $request)
    {
        ...
        return redirect()->route('frontend.email-logs.index');
    }
    ...
    public function edit(EmailLog $emailLog)
    {
        ...
        return view('frontend.emailLogs.edit', compact('emailLog'));
    }
    ...
    public function show(EmailLog $emailLog)
    {
        ...
        return view('frontend.emailLogs.show', compact('emailLog'));
    }
