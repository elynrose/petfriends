...
class SpamIpController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.spamIps.index', compact('spamIps'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.spamIps.create');
    }
    ...
    public function store(StoreSpamIpRequest $request)
    {
        ...
        return redirect()->route('frontend.spam-ips.index');
    }
    ...
    public function edit(SpamIp $spamIp)
    {
        ...
        return view('frontend.spamIps.edit', compact('spamIp'));
    }
    ...
    public function show(SpamIp $spamIp)
    {
        ...
        return view('frontend.spamIps.show', compact('spamIp'));
    }
